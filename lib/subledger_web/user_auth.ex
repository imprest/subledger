defmodule SubledgerWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule SubledgerWeb.PageLive do
        use SubledgerWeb, :live_view

        on_mount {SubledgerWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{SubledgerWeb.UserAuth, :ensure_authenticated}] do
